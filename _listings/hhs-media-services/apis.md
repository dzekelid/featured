...
created: "2018-06-18"
modified: "2018-06-18"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/featured/master/_listings/hhs-media-services/apis.md
...
- name: HHS Media Services Get the list of featured content in the syndication system
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/featured/master/_listings/hhs-media-services/resourcesmediafeatured-json-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/featured/master/_listings/hhs-media-services/resourcesmediafeatured-json-get-openapi.md
- name: HHS Media Services
  x-api-slug: hhs-media-services
  description: Use this API platform to create sites with text and multimedia content
    for syndication. CDC, FDA, HHS, and NIH have built syndication sites using this
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/featured/master/_listings/hhs-media-services/openapi.md
x-common:
- type: x-website
